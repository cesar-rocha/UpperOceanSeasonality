...
\bdp
  \item  \noindent{The reviewer is correct that free IGWs have frequencies between the inertial
         and buoyancy frequencies.  In line 166 (and elsewhere) we use the
         qualifier super-inertial to emphasize the part of the IGW spectrum that have
         frequencies larger than $f$ (as opposed to near-inertial
         IGWs that have frequencies close to $f$).}
\edp
...
\bdp
    \item \noindent Our interpretation of the seasonally varying upper-ocean at
                    scales between 10-100 km focuses two regions of the spectrum:
                    sub-inertial flows (region 1) and super-inertial motions that
                    are dominated by IGWs (region 2). These two regions have
                    out-of-phase seasonal cycle.\\

          \noindent We have discussed these spectra with Young and Wagner.
          The $2f$ wave generation is indeed a possibility (it's the first harmonic
          of the energetic near-inertial waves). But we note that $2 f_{32.5}$ is
          close to energetic $M_2$ tide, and the strong seasonally varying signal
          at high-wavenumber appears to be associated with $M_2$ tide. The $2 f_{32.5}$
          line was added to those plots because \textit{parametric subharmonic instability}
          may take place, but PSI may not be fully resolved by this model. To avoid
          misleading the reader, we have removed the $f_{32.5}$ reference line from the spectra.
\edp
