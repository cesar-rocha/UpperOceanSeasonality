...
\item Table S2 The mean-square velocity at submesoscales (10-100 km)
        estimated from the wavenumber-frequency spectrum of SSH variance in figure S7.
...
LLC4320 and LLC2160 simulations are 1/48$^\circ$ and 1/24$^\circ$,
...
%\caption{Caption text here}
 ...
 \begin{figure}
    \begin{center}
      \setfigurenum{S2}
      \includegraphics[width=40pc]{figs/figS2.pdf}
 ...
 \begin{figure}
    \begin{center}
      \setfigurenum{S7}
      \includegraphics[width=40pc]{figs/figS7.pdf}
 ...
 \begin{table}
 \label{tab1}
 \caption{The mean-square velocity at submesoscales (10-100 km)
         estimated from the wavenumber-frequency spectrum of SSH variance in figure S7.
         }
   \begin{center}
     \begin{tabular}{  l | c | c }
     ...
     & April & October\\
     \hline
   sub-inertial ($<0.8f$)   & 0.32 m s$^{-1}$ & 0.20 m s$^{-1}$  \\
   super-inertial ($>1.2f$) & 0.17 m s$^{-1}$  & 0.46 m s$^{-1}$\\
   near-$f$ ($0.8-1.2 f$) & 0.25 m s$^{-1}$  & 0.12 m s$^{-1}$\\
   near-$M_2$ ($0.8-1.2 M_2$) & 0.05 m s$^{-1}$  & 0.10 m s$^{-1}$\\
   \hline
     \end{tabular}
   \end{center}
 \end{table}
