...
\begin{abstract}
    Submesoscale turbulence, fueled by ample potential
    energy stored in wintertime deep mixed layers, undergoes vigorous seasonality.
    ...
    seasonal cycles. The present results imply a strong seasonal modulation of
    the skill and accuracy of geostrophic velocity diagnostics from submesoscale
