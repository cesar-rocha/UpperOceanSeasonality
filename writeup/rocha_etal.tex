...
and strain by about 40$\%$.
 ...
 \begin{figure*}[ht]
  ...
  \caption{\small Time series of the root-mean-square (RMS) of (a) vorticity,
...
\begin{figure*}[ht]
 ...
 \caption{\small Seasonal variation of joint probability distributions:  vorticity vs.\
...
seasonality of super-inertial and subinertial submesoscale flows. More importantly,
inertia-gravity
waves account for most of the enhancement of super-inertial SSH variance in October.
...
\begin{figure*}[ht]
 ...
 \caption{\small LLC4320 Wavenumber-frequency spectrum of SSH variance in (a) April and (b) October.
          (c) The ratio between (b) and (a) --- the ratio is masked in regions
          with SSH variance density smaller than $10^{-2}$ m$^2$/[cpkm $\times$ cph].
          The light gray shaded region depicts the dispersion relations for inertia-gravity
