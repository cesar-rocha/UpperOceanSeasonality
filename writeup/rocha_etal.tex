...
\begin{abstract}
    ...
    prevails in wintertime. Inertia-gravity waves, on the other hand, are enhanced near
    the surface when the upper ocean in strongly stratified. Hence, in summertime,
    inertia-gravity waves strongly dominate the surface kinetic energy and
    sea-surface height variance at submesoscales.
\end{abstract}
...
Because submesoscale turbulence is significantly diminished in late Summer/early Fall,
