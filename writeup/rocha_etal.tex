...
the latter is dominantly in geostrophic balance \cite{sasaki_etal2014,callies_etal2016}
is overstated; it is only the daily-averaged fields that are to a large extent
in  geostrophic balance (the jPDF of daily-averaged vorticity vs. laplacian of SSH
is a ellipsis with large eccentricity with main axis tilted by 45$^\circ$; figure \ref{fig3}n).
...
residual fields
(figure \ref{fig3}p and \ref{fig3}r), which is an ellipsis aligned in the vertical axis.
