...
inertia-gravity waves, particularly modes two through four --- higher vertical
...
%\ref{fig5}a). But this suppression is dramatic in October, when the inertia-gravity waves peak. At scales
...
Windy near-inertial wave (NIW) generation is bursty and peaks in winter \citep[e.g.,][]{alford2003}.
...
submesoscale (10-100 km) near-inertial waves \citep{young_benjelloul1997}. But in our
simulations the wavy seasonality in submesoscale surface KE and SSH variance is mostly accounted for
by inertia-gravity waves with periods shorter than 12.4 h (Figure \ref{fig4}a-b).
