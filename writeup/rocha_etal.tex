...
% now SWOT
The upcoming Surface and Water Ocean Topography (SWOT) mission will measure
sea-surface height (SSH) on global scale with resolution of about 20 km, nearly
ten time higher than current nadir-looking altimeters. Thus the study of the
partition between geostrophic and ageostrophic flows across the submesoscales and
the quantification of their seasonality seasonality has an important application
to planning of the SWOT
mission. In particular, the presence of inertia-gravity waves may be consider
noise if one wants to diagnose surface currents from SSH.
...
\citet{rocha_etal2016} --- for details, see supplemental material.
...
But in our simulations the higher frequency inertia-gravity-wave
account for most of the seasonality in super-inertial surface KE and SSH
(Figure \ref{fig4}a-b), likely because submesoscale
