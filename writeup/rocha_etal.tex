...
\begin{abstract}
    ...
    vigorous modulation of near-surface dynamics at submesoscales
    (10-100 km) in the Kuroshio Extension. The analysis uses outputs of general
    circulation models spun-up from a state estimate and forced by high-frequency
    winds, surface fluxes, and tides.
    Consistent with recent studies, deep late-winter mixed layers
    are prone to shallow baroclinic instabilities and submesoscale turbulence
    prevails in late winter/early spring. Summertime
    re-stratification, however, weakens submesoscale turbulence and enhances submesoscale inertia-gravity
     waves near the surface. In the Kuroshio Extension,
    inertia-gravity waves dominate the submesoscale surface kinetic energy and
    ...
    high-resolution satellite altimeters.
\end{abstract}
...
challenge --- and opportunity ---  for SWOT is the presence of ageostrophic flows
that straddle the submesoscales and project
...
statistics obtained via spectral differentiation are 10-15$\%$ larger.
We then diagnose
...
statistics of vorticity, strain, and divergence are apt descriptors of these
