...
\begin{abstract}
    The vigorous seasonal cycle of mixed layer modulates upper-ocean submesoscale turbulence.
    Here we provide model evidence that the seasonally-changing upper-ocean
    stratification also modulates submesoscale  (here 10-100 km)
    ...
    the skill and accuracy of geostrophic velocity diagnosed from submesoscale
    sea-surface height delivered by the Surface and Water Ocean Topography (SWOT)
    satellite mission
\end{abstract}
...
The projection of energetic submesoscale ageostrophic flows, such as
inertia-gravity waves (IGWs), onto SSH represents
a challenged --- and an opportunity --- for SWOT. The challenge: how to diagnose
surface velocity from SSH. The opportunity: observations of submesoscale ageostrophic
flows on global scale.
...
Tidal forcing by the 16 most-significant components represents a key feature LLC2160 and
...
radius has only a secondary, catalytic role --- most of the baroclinic convertion occurs at
...
\begin{acknowledgments}
 William R. Young and the reviewers --- Christian Buckingham and two anonymous referees ---
  provided helpful and constructive comments. Greg Wagner
