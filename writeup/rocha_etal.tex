...
\begin{abstract}
    ...
    sea-surface height variance in late Summer/early Fall at submesoscales.
\end{abstract}
...
Fundamentally, the stratification and its seasonality are well-captured by both LLC simulations:
...
is an ellipse with large eccentricity with main axis tilted by 45$^\circ$; figure \ref{fig3}h).
...
\ref{fig4}a). But this suppression is dramatic in October, when the horizontally
