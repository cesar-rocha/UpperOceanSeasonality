...
as deep as 300 m (Figure \ref{fig1}d). In late spring/early summer enhanced solar radiation and mixed-layer
instabilities re-stratify the upper ocean, yielding mixed layers as shallow as 40 m (Figure \ref{fig1}e).
...
\begin{acknowledgments}
 William R. Young provided helpful feedback on the first draft. Greg Wagner first
