...
We thank the reviewers for the speedy reviewer, constructive criticism, and
great suggestions. 
...
\begin{enumerate}
  ...
  \item {\it There needs to be a discussion about the effective resolution of your model. The fact that
        ...
        \bdp
            ...
            The ``unresolved energy'' does not come from anywhere; it is unresolved.
            To the extend that 1-km-scale are associated with a forward
            energy transfer, then their effects on the scales concerning our study
            (10-100 km) are likely energetically insignificant.
            Also important to this discussion is that higher resolution simulations will resolve
            1-km-scale eddies and high-wavenumber IGWs that are generated through wave-wave
            interactions and wave-vorticity interactions.\\

            Buckingham et al. (2016) have a very good point that models and observations
            to date may not resolve the mixed-layer deformation scale in summer; this is no
            different for our simulations. But summer is also the season when lateral buoyancy
            gradients (and thus available potential energy) are minimum within the mixed layer,
            so the reviewer's conjecture that this is the main source of seasonally varying eddy
            kinetic energy is not obvious.\\

            For geostrophically balanced mixed-layer instabilities (which we call
            ...
            QG turbulence driven by ML instabilities (Callies et al. 2016) the
            deformation scale has only a catalytic role, where eddy baroclinic
            energy is converted into (mixed-layer) eddy barotropic energy; as
            in interior baroclinic geostrophic turbulence, most of the baroclinic
            conversion occurs at larger scales (Callies et al. 2016).

            Still, we recognize that this issue may be further investigated and
            we included a paragraph to the discussion.
 ...
 \item {\it If the authors could estimate the magnitude of the sea surface height signature within a
        ...
        \bdp
            ...
            spectrum of SSH (Figure 4) to estimate variance in a particular frequency
            bands.  We have included a table with the standard
            deviation of SSH for super-inertial and sub-inertial flows at scales
            smaller than 100 km in different seasons. Thanks for the great suggestion!
        \edp
