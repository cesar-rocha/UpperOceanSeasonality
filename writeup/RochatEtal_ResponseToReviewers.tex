...
comments. The most fundamental change is the inclusion of a wavenumber-frequency
...
forced us to provide a better context for our study.
...
\begin{enumerate}
  ...
  \item {\it There needs to be a discussion about the effective resolution of your model. The fact that
        ...
        \bdp
            ...
            1-km-scale eddies and high-wavenumber IGWs that are generated via wave-wave
            interactions and wave-vorticity interactions.\\

            Buckingham et al. (2016) made a very good point that models and observations
            ...
            source of seasonally varying eddy kinetic energy is simplistic because
            ...
            most of the baroclinic
            conversion occurs at scales much large than the mixed-layer deformation
            scale (Callies et al. 2016).
...
\begin{enumerate}
  ...
  \item {\it (Section 1, Paragraph 3) What types of horizontal and temporal scales for IGWs are
        ...
        \bdp
          ...
          term submesoscale IGWs.}; IGWs have periods  The GM spectrum is inaccurate
...
\item {\it (Figure 4b) Strictly speaking, the label on the y-axis should not be SSH variance. SSH
      ...
      to the pervasive axis poor-labelling in plots of probability distribution function (PDF)
