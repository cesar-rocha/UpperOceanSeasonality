...
\item {\it (Figure 4b) Strictly speaking, the label on the y-axis should not be SSH variance. SSH
      ...
      We disagree that the label of the y-axis should be \textit{power spectral density of SSH}
      or \textit{SSH spectra} [{\it sic}]. On physical grounds, \textit{power spectrum} is a misleading term,
      because SSH variance density has nothing to do with \textit{power}.\footnote{The
      term \textit{power spectrum} was for the \textit{frequency} spectrum of some quantities.}
      ...
      --- the correct label of the y-axis is \textit{probability density}
      not PDF.}
      \edp
