...
\begin{enumerate}
  ...
  \item {\it (Section 1, Paragraph 1) The authors use the term ``submesoscale'' and ``mesoscale'' as
      ...
      \bdp
          ...
          Also, the scales of equilibrated baroclinic geostrophic turbulence are
          larger than the deformation radius (e.g., Larichev \& Held 1995),
          although linear theorists always deploy ``deformation radius'' as
          ...
          our definition: (i) this is the definition used by the SWOT community (Fu \& Ferrari
              ...
              scales smaller then about 100 km; and (ii) our goal is determine the flows
