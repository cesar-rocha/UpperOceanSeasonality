...
submesoscale flows is strong (e.g., those relating to Figure 1b-c and Figure 2).}\\
    ...
    \bdp
        ...
        that sentence and we believe the new Figure 4 will more efficiently convey
        the phase cancellation point.
    \edp
...
\item {\it (Figure 3) Would be nice to include a third row that contains the collapsed (i.e., one-
      ...
      \bdp
        Added. Yes, as we mention in the text, we have normalized by those
