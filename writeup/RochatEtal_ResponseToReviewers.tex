...
between 10 and 100 km. We have also expanded the introductions and discussion
to place our study in the context of Surface Water \& Ocean Topography (SWOT)
satellite mission --- we discuss
the implications of our findings for the estimation of surface velocity from
high-resolution sea-surface height.

We thank the reviewers  for the speedy review, constructive
criticism, and fine suggestions, which has helped us improve our discussion and
forced us to provide a better context for our study. We hope our manuscript is
now suitable for publication and look forward to you reply.
...
submesoscale flows is strong (e.g., those relating to Figure 1b-c and Figure 2).}\\
    ...
    \bdp
        ...
        that sentence from the text. We also believe the new Figure 4 will convey
...
turbulence versus inertia-gravity waves.}
  ...
  \bdp
      The mesoscale eddy KE level compares well to gridded AVISO
      geostrophic KE. \\\textcolor{purple}{Need to do the comparison with alon-track data}.
  \edp
...
\begin{enumerate}
  ...
  \item {\it First of all, generation mechanism of submesoscale inertial-gravity waves in summer
        ...
        \bdp
          ...
          (D'saro 1978; cf. second paragraph of discussion).\\
          ...
          \textcolor{purple}{Dimitris --- can I have access to the tideless 18-km LLC output?}
      \edp
...
\begin{enumerate}
  ...
  \item {\it There needs to be a discussion about the effective resolution of your model. The fact that
        ...
        \bdp
            ...
            \cite{buckingham_etal2016} made a very good point that models and observations
            ...
            \textcolor{purple}{Is it worth to add a paragraph to discuss this?}
...
\begin{enumerate}
  ...
  \item {\it (Section 1, Paragraph 3) What types of horizontal and temporal scales for IGWs are
        ...
        \bdp
          ...
          term submesoscale IGWs.}; IGWs have periods bettwen the inertial and buoyancy
 ...
 \item {\it Discretization of the underlying equations of motion. How do you expect the
        ...
        \textcolor{purple}{Dimitris --- do you want to pitch in a reply for this question?}
...
\item {\it (Section 4, last paragraph) ``consistent with linear inertia-gravity waves''.
        ...
        \bdp
            \textcolor{purple}{Ask Bill --- I haven't found any reference that mentions this
            fact explicitly, but it follows from the linear boussinesq equations, which can
            be combined to yield $\zeta_t= f_0 \delta$.}
        \edp
...
\item {\it (Figure 2) What is the sensitivity of the estimates to the stencil type? See Arbic et al.
        ...
        \bdp
            Our scheme likely slightly underestimates the vorticity. \textcolor{purple}{
            I will perform a sensitivity analysis.}
        \edp
...
\item {\it 24. (Section 3, Paragraph 1) ``These diagnostic highlight the submesoscale structures in
      ...
      \bdp
        ...
        We argue that most physical oceanographers  will likely
